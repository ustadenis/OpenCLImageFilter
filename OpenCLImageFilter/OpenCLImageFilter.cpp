...
// OpenCLImageFilter.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(COpenCLImageFilterApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание COpenCLImageFilterApp

COpenCLImageFilterApp::COpenCLImageFilterApp()
{
...
// Единственный объект COpenCLImageFilterApp

COpenCLImageFilterApp theApp;


// инициализация COpenCLImageFilterApp

BOOL COpenCLImageFilterApp::InitInstance()
{
